...
#
# =============================================================================
# Script:  pub-timestamp.py
# Purpose: MQTT latency PUBLISHER for the ToD testbed. Continuously publishes
#          the current Unix timestamp to "set/<ms>" every 100 ms. Paired with
#          sub-timestamp.py (the subscriber) it measures end-to-end message
#          latency / jitter through the broker, including during fault injection.
#
# Usage:   ./pub-timestamp.py <ms_name>
#          e.g. ./pub-timestamp.py speed  -> publishes to "set/speed",
#                                            subscribes to "get/speed"
#
# Config:  BROKERIP   env var (required) - MQTT broker host
#          BROKERPORT env var (required) - MQTT broker port
# Behaviour: Auto-reconnect on unexpected disconnect; runs until interrupted.
# =============================================================================
