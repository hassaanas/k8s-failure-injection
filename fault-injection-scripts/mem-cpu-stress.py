#!/usr/bin/env python3
# =============================================================================
# Script:  mem-cpu-stress.py
# Purpose: Self-contained, pure-Python CPU + memory stressor meant to be run
#          INSIDE a container/pod (no external tools like stress-ng needed). It
#          generates a controlled, "safe" load to test resource limits, HPA,
#          throttling and recovery during ToD fault-injection experiments.
#
# Behaviour:
#   - Memory: detects the cgroup memory limit (v1 and v2 supported, falls back
#             to physical RAM) and allocates MEMORY_FRACTION of it (default 50%).
#   - CPU:    spawns one worker thread per CPU core, each busy-looping at
...
#   capped near a single core's worth of work rather than per-core; use a
#   multiprocessing approach if true per-core saturation is required.
# =============================================================================
"""
